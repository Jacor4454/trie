    ...
    while exis:
        ...
        for i in range (0, len(recreation)):
            for j in range (0, len(recreation[i][2])):
                ...
                pygame.draw.line(win, (0,0,0), (int(400*(tt[i]/(width[depth[i]-1]+1))), int(400*(depth[i]/(biggest+1))-20)), (int(400*(tt[dest]/(width[depth[dest]-1]+1))), int(400*(depth[dest]/(biggest+1))-20)), 2)
