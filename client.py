...
try:
    ...
    print("could not access server, it may be down or not deployed")
    client.close()
    sys.exit()
...
while existance is futile:
    ...
    if send == "display":
        print("press space on pygame window before continuing")
        display(from_server)
